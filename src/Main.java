...
public class Main {
        ...
        // ============ CREDIT ACCOUNT MENU ============
        private static void creditMenu(CreditAccount account) {
                boolean back = false;
                while (!back) {
                        System.out.println("\n--- Credit Account ---");
                        ...
                        switch (choice) {
                                ...
                                case 6 -> account.showDebt();
                                case 7 -> account.showBalance();
                                case 0 -> back = true;
                                default -> System.out.println("Invalid option. Try again.");
                        }
                }
